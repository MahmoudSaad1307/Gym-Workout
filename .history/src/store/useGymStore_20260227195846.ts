...
const defaultExercises: Exercise[] = [
  ...
  // Push
{ id: 'push-5', name: 'Shoulder Press', split: 'Push', imageUrl: '' },
{ id: 'push-6', name: 'Lateral Raises', split: 'Push', imageUrl: '' },
{ id: 'push-7', name: 'Triceps Cable Overhead', split: 'Push', imageUrl: '' },
{ id: 'push-8', name: 'Triceps Push Down', split: 'Push', imageUrl: '' },
// Pull
{ id: 'pull-1', name: 'Rear Delt Fly', split: 'Pull', imageUrl: '' },
