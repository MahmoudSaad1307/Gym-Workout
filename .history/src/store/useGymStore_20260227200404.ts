...
{ id: 'pull-4', name: 'Hammer Curl', split: 'Pull', imageUrl: 'https://cdn.muscleandstrength.com/sites/default/files/standing-hammer-curl.jpg' },
{ id: 'pull-5', name: 'T-Bar Row', split: 'Pull', imageUrl: 'https://cdn.muscleandstrength.com/sites/default/files/t-bar-row.jpg' },
{ id: 'pull-6', name: 'Lateral Row Machine', split: 'Pull', imageUrl: 'https://cdn.muscleandstrength.com/sites/default/files/lateral-row-machine.jpg' },
{ id: 'pull-7', name: 'Shrugs', split: 'Pull', imageUrl: 'https://cdn.muscleandstrength.com/sites/default/files/shrugs.jpg' },
// Arms & Core
